...
| DataFactory            | draft        | Regional event-data context  | Latin American commercial event-data coverage.                   | [datafactory.md](datafactory.md)                 |
...
| Hawk-Eye               | draft        | Officiating/tracking context | Goal-line and tracking technology ecosystem.                     | [hawkeye.md](hawkeye.md)                         |
...
| Metrica Sports         | draft        | Tracking sample context      | Anonymised public tracking sample and commercial feed context.   | [metrica.md](metrica.md)                         |
| PFF FC                 | draft        | Open tracking corroborator   | Public 2022 World Cup tracking data plus commercial context.     | [pff.md](pff.md)                                 |
| Second Spectrum        | draft        | Commercial tracking context  | Optical-tracking ecosystem with no public bridge.                | [secondspectrum.md](secondspectrum.md)           |
| Signality              | draft        | Commercial tracking context  | Spiideo-linked optical-tracking ecosystem.                       | [signality.md](signality.md)                     |
...
| Sportec Solutions      | draft        | Bundesliga data context      | DFL/Bundesliga event and tracking data with small public sample. | [sportec.md](sportec.md)                         |
| Sportradar             | draft        | Commercial data context      | Typed `sr:*` URN namespaces across football entities.            | [sportradar.md](sportradar.md)                   |
| TRACAB                 | draft        | Commercial tracking context  | Commercial optical-tracking provider with no public bridge.      | [tracab.md](tracab.md)                           |
...
| -------------- | --------------------------------------- | -------------------------------------------------------- |
| Wyscout/InStat | Hudl scouting and event-data platforms. | Provider relationship to StatsBomb and Impect ecosystem. |
